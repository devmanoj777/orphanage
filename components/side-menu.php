...
<div class="four wide column" id="example1">
    <div class="ui secondary vertical pointing menu">
        ...
        <a class="item <?php echo ($_SERVER['PHP_SELF'] == "/orphan/child-gallery-sponsored.php" ? "active" : "");?>" href="child-gallery-unsponsored.php">Child Gallery</a>
        ...
        <a class="item <?php echo ($_SERVER['PHP_SELF'] == "/orphan/donation.php" ? "active" : "");?>" href="child-gallery-unsponsored.php">Adoption</a>
