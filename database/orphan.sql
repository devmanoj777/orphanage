...
--
-- Host: 127.0.0.1
-- Generation Time: May 13, 2023 at 10:50 AM
...
CREATE TABLE `adopt` (
  ...
  `ad_phone` int(100) NOT NULL,
  `ad_address` varchar(200) NOT NULL,
  `cid` int(100) NOT NULL,
  `ad_cdname` varchar(100) NOT NULL
...
INSERT INTO `adopt` (`id`, `ad_firstname`, `ad_lastname`, `ad_email`, `ad_phone`, `ad_address`, `cid`, `ad_cdname`) VALUES
(1, 'First', 'name', 'adfd@fmakdlhg', 2147483647, 'dsagadgfdhg', 8, ' suraj');
